...
export class AdminDataService {
  ...
  // Customers
  getAllCustomers(paginate: Pagination, sort?: any, filter?: any, select?: string) {
    return this.httpClient.post<{ data: User[], count: number, message: string }>(API_ADMIN + 'get-all-customers', {paginate, sort, filter, select});
  }
  getSelectedUserDetails(selectedIds:string[]){
    return this.httpClient.post<{ data: User[], count: number }>(API_ADMIN + 'get-selected-user-details', {selectedIds});
  }
  }
