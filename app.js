...
app.post('/callback/payment/cancel', (req, res) => {
  ...
  res.redirect(301, 'https://careme.softlabit.com/payment/cancel')
...
app.post('/callback/payment/success', (req, res) => {
  ...
  res.redirect(301, 'https://careme.softlabit.com/payment/success')
  // console.log(req.body);
  // res.status(200).json({
  //   data: req.body,
  //   message: 'Data Retrieved Successfully!'
...
app.post('/callback/payment/fail', (req, res) => {
  ...
  res.redirect(301, 'https://careme.softlabit.com/payment/fail')
  // console.log(req.body);
  // res.status(200).json({
  //   data: req.body,
  //   message: 'Data Retrieved Successfully!'
